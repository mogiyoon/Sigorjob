...
a = Analysis(
    ...
    hiddenimports=['aiosqlite', 'uvicorn.logging', 'uvicorn.loops', 'uvicorn.loops.auto', 'uvicorn.protocols', 'uvicorn.protocols.http', 'uvicorn.protocols.http.auto', 'uvicorn.lifespan', 'uvicorn.lifespan.on', 'connections', 'connections.base', 'connections.manager', 'connections.registry', 'connections.drivers', 'connections.drivers.google_calendar', 'connections.drivers.template_connector'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
